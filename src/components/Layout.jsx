          ...
          <div className="footer-content">
            ...
            <div className="footer-links">
              ...
              <div className="footer-section footer-partners">
                <h4>Síguenos</h4>
                <a href="https://www.instagram.com/vuelo.producciones/" target="_blank" rel="noopener noreferrer" className="footer-instagram-link" aria-label="Instagram de Vuelo Producciones">
                ...
                <a href="https://www.instagram.com/menjunjetv/" target="_blank" rel="noopener noreferrer" className="footer-instagram-link" aria-label="Instagram de MenjunjeTV">
